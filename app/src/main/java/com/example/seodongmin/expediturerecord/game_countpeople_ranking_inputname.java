...
public class game_countpeople_ranking_inputname extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button.OnClickListener ok_listener = new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent result_intent = new Intent(game_countpeople_ranking_inputname.this, game_calculateit_play.class);
